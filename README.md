...
```
rm -rf install-xray-bot.sh && wget -O /root/install-xray-bot.sh https://raw.githubusercontent.com/superdecrypt-dev/bot-discord-xray/master/install-xray-bot.sh && chmod +x install-xray-bot.sh && ./install-xray-bot.sh
```
